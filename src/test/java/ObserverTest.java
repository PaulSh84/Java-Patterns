import ObserverPattern.MessageStream;
import ObserverPattern.SlackClient;
import ObserverPattern.Subject;
import ObserverPattern.WhatsAppClient;
...
public class ObserverTest {
    ...
    public void observerTest() {
        ...
        slackClient.addMessage("Another great message!");
        Assert.assertEquals("Another great message! " + "- sent from Slack",    subject.getState());
